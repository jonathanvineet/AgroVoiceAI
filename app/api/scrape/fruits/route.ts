...
export async function POST(req: NextRequest) {
  try {
    ...
    console.debug('[Scrape/Fruits] Requested URL:', websiteUrl, 'Status:', response.status, 'BodyLength:', response.data?.length)
    ...
    console.warn('[Scrape/Fruits] Error fetching:', error)
